...
dependent_packages <- c("cluster", "rattle.data", "NbClust")
...
scaled_wine_data <- scale(wine[,c(2:ncol(wine))])
...
##------
## Answer: This method suggest to use 3 clusters
##------
...
wine_cluster_comparison <- table(wine$Type, fit.km$cluster)
print(wine_cluster_comparison)

# Exercise 6:
# * Visualize these clusters using  function clusplot() from the cluster library
# * Would you consider this a good clustering?

clusplot(scaled_wine_data, fit.km$cluster)
